...
| `watch_failed`          | The proxy lost its watch on the file (for example, the file was replaced by one it cannot read). Nothing was read; it keeps serving the running policy and observes no later edit until it is restarted.                                                   |
