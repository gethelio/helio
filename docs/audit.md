...
| `rejected_invalid`, `rejected_unroutable`, `rejected_budget_flush`, `rejected_pinned` | On `policy_reload` records only: the reload attempt was refused for that reason (see [Policy Reload Records](#policy-reload-records)).                                                                                                                                                                     |
