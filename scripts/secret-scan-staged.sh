...
if ! run_gitleaks "${TMP_DIR}"; then
  echo "" >&2
  echo "Commit blocked: staged changes contain a potential secret or scanner failed." >&2
  echo "If this is a placeholder, narrow the allowlist in .gitleaks.toml." >&2
  exit 1
fi
